...
public class AdapterProfile extends BaseAdapter {
    ...
    public AdapterProfile(Context mContext, List<Maska_Vertikal> maskListVertikal)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
           // new AdapterVertikal.DownloadImageTask((ImageView) Image).execute(mask.getImage());
